                ...
                <div className='container_account'>
                    ...
                    <div className='center_account'>
                        ...
                        <div>
                            ...
                            <input value={account.username} readOnly className='input_account' />
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type='radio' name='gender' readOnly checked={account.gender === 'Nam' || account.gender === 'male'} /> Nam
                            <input type='radio' name='gender' readOnly checked={account.gender === 'Nữ' || account.gender === 'female'} /> Nữ
                        </div>
                        <div>
                            <label className='label_account'>Ngày sinh</label>
                            <input type='date' value={account.birthday} readOnly className='input_account' />
                        </div>
                        <div>
                            <label className='label_account'>Địa chỉ</label>
                            <input value={account.address} readOnly className='input_account' />
                        </div>
                    </div>
                    <div className='right_account'>
                        ...
                        <p> Dung lượng file tối đa 1MB.
                            <br />Định dạng: .JPEG, .PNG</p>
                    </div>
                </div>
            </div>
        </div>
